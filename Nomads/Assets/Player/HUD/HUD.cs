...
public class HUD : MonoBehaviour
{
    ...
    public Texture2D ready, charging;
    ...
    void Start()
    {
        ...
        ResourceManager.StoreSelectBoxItems(selectBoxSkin, healthy, damaged, critical, ready, charging);
    ...
    private void DrawOrdersBar()
    {
        ...
        if (!selectionName.Equals(""))
        {
            ...
            topPos = buildAreaHeight + BUTTON_SPACING;
